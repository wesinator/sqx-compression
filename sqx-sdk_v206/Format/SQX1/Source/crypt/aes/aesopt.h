...
#if !defined(__AES_COMP_H)						//- 07/20/2002 R.N.
#include "aes_comp.h"
#endif
...
#  endif
#elif defined(__KNOWN_COMPILER__)
#  include <stdlib.h>
#elif !defined(WIN32)
#  include <stdlib.h>
...
/*  2. BYTE ORDER IN 32-BIT WORDS
    ...
    ways in which various environemnts define byte oprder.  It may well
    fail, in which case the definitions will need to be set by editing at
    the points marked **** EDIT HERE IF NECESSARY **** below.
*/

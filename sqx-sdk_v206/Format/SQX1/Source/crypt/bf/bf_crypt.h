...
#if !defined(__BF_CRYPT_H)   //- include this file only once per compilation
#define __BF_CRYPT_H
...
#define	BLOWFISH_BYTE_BLOCKLEN 8
...
void InitBfEncrypt(void);
void BfDecrypt(UBYTE *pBuffer,UWORD32 uBufSize);

#endif //- #if !defined(__BF_CRYPT_H)   

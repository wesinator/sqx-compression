...
//- in sqx_dec.c
extern int OpenNextVolume(void);

UWORD32 uBitBuf;			//- bits in bitbuf
UWORD32 uBitBufBits;		//- # of bits valid in bitbuf
UWORD32 uBitBufPos;			//- pos in bitbuf
UWORD32 *ualBitStreamBuf;	//- bit buffer
UWORD32 uBTBlockPtr;		//- # of compressed signals
